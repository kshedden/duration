__This repository is no longer being actively developed.  See [here](https://github.com/kshedden/statmodel/tree/master/duration) for the new version of this package.__
